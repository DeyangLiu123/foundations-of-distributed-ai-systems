...
全课程共 **70 节**：63 节理论课 + 6 节实践课（L09 / L19 / L39 / L48 / L62 / L68）+ 1 节选修（L70）。每节课是一篇独立的 Obsidian 笔记，正文约 3000–6000 字，30–60 分钟读完。
...
| L65 | [[L65 推理服务生存性]] | 在线服务的生存性工程：failover、降级服务、SLO 违约与多地域容灾 | availability, failover, hedged request, degraded service, error budget, multi-region |
| L66 | [[L66 弹性算力与资源效率]] | 用不稳定的算力做稳定的事：spot 训练、弹性伸缩、GPU 共享 | spot instance, elastic training, MIG/MPS, serverless inference, carbon-aware |
| L67 | [[L67 测量仿真与评测]] | 没有万卡怎么做研究：测量论文、trace、ASTRA-sim 与 ns-3 | measurement, trace, ASTRA-sim, ns-3, SimAI, MLPerf, fidelity |
| L68 | [[L68 实践-仿真上手]] | 【实践】跑通 ASTRA-sim：手算 → 仿真 → 校准的第一次闭环 | —— |
| L69 | [[L69 研究地图与论文清单]] | 领域版图、20 篇必读论文与从课程到研究的路线 | —— |
| L70 | [[L70 选修-多模态与新负载]] | 【选修】VLM、扩散模型、Agent 与 RAG：新负载如何改变系统需求 | ViT, diffusion/DiT, agentic workload, RAG, vector database |

## 五、学习路线

**默认路线**：按编号顺序 L01→L69（L70 选修）。建议每周 3–4 课 + 每周一次 1 小时讨论班（轮流讲「算一算」和自测题），一个学期完成。

**方向路线**（急着读某一类论文时用）。规则：**精读** = 完整学；**速读** = 30 分钟过主图、「算一算」和术语卡。闭包保证是**一级的**：每门精读课的**直接前置**都在该路线（精读或速读）内；速读课自己的更早前置允许缺席——速读只要求带走结论，遇到不懂的链接跳过即可，不追溯到底。例外：L69 是导航课，前置为「完成你所选的路线」，未修模块的版图内容当索引用。所有路线仍按编号顺序读。

- **推理 / Serving 方向**（精读 23 + 速读 16）
  精读：L10–L13, L16–L18, L22–L23, L36–L37, L43, L46, L55–L62, L65, L69
  速读：L01–L02, L04–L05, L20–L21, L24–L25, L35, L40–L42, L44–L45, L47, L53
- **训练 Infra 方向**（精读 33 + 速读 11）
  精读：L03–L07, L12–L14, L16–L17, L22–L24, L36–L39, L40–L48, L49–L54, L69
  速读：L01–L02, L10–L11, L15, L20–L21, L25–L26, L34–L35
- **网络方向**（精读 29 + 速读 18；网络是本课程的贯穿视角，这条路线最厚是诚实的）
  精读：L27–L39, L41, L43–L44, L46–L47, L53, L55–L57, L60–L61, L63, L65–L67, L69
  速读：L01–L02, L10–L14, L16–L17, L20–L23, L25, L40, L42, L45, L52
